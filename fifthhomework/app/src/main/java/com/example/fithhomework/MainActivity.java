package com.example.fithhomework;
...
import com.example.fithhomework.bean.UserInfo;
import com.example.fithhomework.database.UserDBHelper;
import com.example.fithhomework.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener,View.OnClickListener{
    ...
    private Switch Sw_remember; // 声明一个开关对象
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Sw_remember.setOnCheckedChangeListener(this);
        initTypeSpinner();
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990006陈奕达"};
        ...
        if (v.getId() == R.id.btn_forget) { // 点击了“忘记密码”按钮s
            ...
            if (rb_password.isChecked()) { // 密码方式校验
                ...
                if (info1 != null) {
                    ...
                    Toast.makeText(this, "没有该用户，请先进行注册", Toast.LENGTH_SHORT).show();
                }
            }
