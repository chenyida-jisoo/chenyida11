...
import com.example.FinallyHomework.bean.UserInfo;
import com.example.FinallyHomework.database.UserDBHelper;
import com.example.FinallyHomework.util.DateUtil;
import com.example.FinallyHomework.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private String[] typeArray = {"个人用户", "公司用户","18990006 陈奕达"};
