package com.example.FinallyHomework.adapter;
...
import com.example.FinallyHomework.widget.RecyclerExtras.OnItemClickListener;
import com.example.FinallyHomework.widget.RecyclerExtras.OnItemLongClickListener;

import java.util.ArrayList;

public class RecyclerGridAdapter extends RecyclerView.Adapter<ViewHolder> implements OnItemClickListener, OnItemLongClickListener{
    ...
    public void setOnItemLongClickListener(RecyclerGridAdapter listener) {
